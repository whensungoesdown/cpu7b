...
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/byp_rs1_data_e
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/byp_rs2_data_e
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs2_mux_sel_w
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs2_mux_sel_rf
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs2_mux_sel_m
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs1_mux_sel_w
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs1_mux_sel_rf
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs1_mux_sel_m
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/rddata_sel_mul_res_m_l
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/rddata_sel_lsu_res_m_l
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/rddata_sel_csr_res_m_l
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/rddata_sel_bru_res_m_l
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/rddata_sel_alu_res_m_l
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/alu_res_m
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/alu_ecl_res_e
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl_alu_b_e
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl_alu_a_e
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/byp_rs2_data_e
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs2_mux_sel_w
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs2_mux_sel_rf
add wave -position end  result:/top_tb/u_top/u_cpu/cpu/exu/ecl/ecl_byp_rs2_mux_sel_m
