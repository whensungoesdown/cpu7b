...
add wave -divider
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/lsu_csr_llb_clr
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/lsu_csr_llb_set
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/csr_lsu_llb
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/lsu_ecl_sc_fin_ls1
add wave -divider
...
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/lsu_addr_ls1
...
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/lsu_biu_wr_addr_ls2
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/lsu_biu_wr_data_ls2
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_exu/u_lsu/lsu_biu_wr_req_ls2
add wave -divider
...
add wave -divider
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_ifu/u_fcl/data_cancel_en
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_ifu/u_fcl/data_cancel_in
...
add wave -position end  result:/top_tb/u_top/u_c7b/u_core/u_ifu/u_fcl/data_stall
